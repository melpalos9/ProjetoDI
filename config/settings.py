...
# Banco de dados (PostgreSQL) - ajuste credenciais se necessário
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": "ProjetoDI",  # <- corrige para o banco certo
        "USER": "postgres",
        "PASSWORD": "123456",
        "HOST": "localhost",
        "PORT": "5432",
...
# Pasta onde `collectstatic` colocará os arquivos para produção
